"""Suite home — linked from st.navigation in app.py."""

from __future__ import annotations

import streamlit as st

from ui import render_attribution, render_sidebar_about
...
st.success("Use the **sidebar links** above: Home · Survey Validation · Usability Testing · A/B Experiment")
